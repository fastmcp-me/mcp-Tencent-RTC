...
3. Fill in the application name, select the product as Chat, and choose an appropriate region.
   ...
   ![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027983637/6a8d0b53167b11efb6495254005ac0ca.png)
...
3. Click `Create account`, and an account creation dialog box will pop up. It is recommended to select `General` for a regular member. Although `Nickname` is not required, we still recommend setting it. If `userID` is not displayed on the UI, you can identify different users through `Nickname`.
   ...
   ![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027983637/69cd0487167b11efb5545254007bbd8c.png)
...
- If you need multiple UI components, you can integrate TUIKit. For details, see [Install TUIKit](https://www.tencentcloud.com/document/product/1047/50057?lang=en&pg=).

- If you only need to integrate TUIChat, see [Install TUIChat Only](https://www.tencentcloud.com/document/product/1047/60168?lang=en&pg=).
...
- userSig, user1's userSig, which can be generated in real time using the development tools provided by the console. The path is: Homepage > Development Tools > UserSig Tools > Signature (UserSig) Generator, as shown below:
   ...
   ![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027983637/69e13ff2167b11efb8ef5254002fd0a8.png)
...
![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027983637/6999304c167b11efb5545254007bbd8c.png)

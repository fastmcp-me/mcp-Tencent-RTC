...
1. Get the integration guide for TRTC Web SDK.｜1. 获取 RTC Engine Web SDK 的集成指南。\n
...
const registryGetRTCEngineWebSDKIntegrationGuideTool = (mcpServer) => {
    mcpServer.tool('get-rtcengine-web-sdk-integration-guide', description, {
...
export { registryGetRTCEngineWebSDKIntegrationGuideTool };
//# sourceMappingURL=get-rtcengine-web-sdk-integration-guide.js.map